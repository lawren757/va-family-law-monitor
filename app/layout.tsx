...
export const metadata: Metadata = {
  title: "VFL Toolkit — Virginia Family Law Monitor",
  description:
    "Code updates, case law, ethics opinions, bar news, and practice trends for Virginia family law practitioners.",
  icons: {
    icon: "/logo-wordmark.png",
  },
};
